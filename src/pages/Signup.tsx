...
const Signup = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Seo title="Create your SpecMirror account" description="Start generating PRDs and engineering specs from plain-English briefs. Free tier — no credit card." path="/signup" noindex />
